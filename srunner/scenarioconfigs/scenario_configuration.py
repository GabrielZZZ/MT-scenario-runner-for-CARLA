...
class ScenarioConfiguration(object):
    ...
    first_actor_location = None
    second_actor_location = None
    first_actor_speed = None
    second_actor_speed = None
    other_actor_max_brake = None
    other_actor_stop_in_front_intersection = None
    first_actor_type = None
    second_actor_type = None